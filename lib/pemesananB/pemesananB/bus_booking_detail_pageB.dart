...
class BusBookingDetailPageB extends StatefulWidget {
  final int selectedSeat;

  const BusBookingDetailPageB({Key? key, required this.selectedSeat})
      : super(key: key);
...
class _BusBookingDetailPageState extends State<BusBookingDetailPageB> {
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            _buildPaymentMethodTile(
                                'Alfamart', 'assets/payment/Alfamart.png'),
                            _buildPaymentMethodTile(
                                'Indomaret', 'assets/payment/indomaret.png'),
                            _buildPaymentMethodTile(
                                'Mobile Banking', 'assets/payment/mobile.png'),
                          ],
                        ),
  ...
  Widget _buildPaymentMethodTile(String title, String assetPath) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              selectedPaymentMethod == title ? Colors.blue[50] : Colors.white,
