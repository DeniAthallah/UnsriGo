...
import 'bus_booking_detail_pageC.dart';

class BusBookingSelectPageC extends StatefulWidget {
  const BusBookingSelectPageC({Key? key}) : super(key: key);

  @override
  State<BusBookingSelectPageC> createState() => _BusBookingSelectPageState();
}

class _BusBookingSelectPageState extends State<BusBookingSelectPageC> {
                  ...
                  onTap: () {
                    if (selectedSeat != null) {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              BusBookingDetailPage(selectedSeat: selectedSeat!),
                        ),
                      );
                    } else {
